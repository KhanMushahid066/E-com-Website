<%-- 
    Document   : navbar
    Created on : Jul 2, 2024, 3:19:47 PM
    Author     : kmush
--%>
...
<nav class="navbar navbar-expand-lg navbar-dark custom-bg">
    <div class="container">
        <a class="navbar-brand" href="index.jsp">My Web</a>
            ...
            <ul class="navbar-nav ml-auto"> 
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="#!" data-toggle="modal" data-target="#cart">
                        <i class="fa fa-cart-plus" style="font-size: 18px;"><span class="ml-0 cart-items">(0)</span></i>
                    </a>
                </li>
